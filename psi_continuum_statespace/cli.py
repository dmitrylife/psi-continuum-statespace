...
This CLI provides both scripted and interactive access to the
macroscopic Psi(z) state-space representation.
"""
...
def build_default_models():
    ...
    Replace eps0 values with best-fit results if needed.
    """
